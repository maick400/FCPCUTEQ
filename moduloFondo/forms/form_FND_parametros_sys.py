...
class frm_parametros_sys(forms.ModelForm):
    class Meta:
        ...
        labels = {
            ...
            'tipo_Aportacion': 'Tipo de Aportacion',
            'valor_aplicable_aportacion': 'Valor Aplicable Aportación',
        }
        widgets = {
            ...
            'tipo_Aportacion': forms.Select(choices=TIPO_APORTACION, attrs={'class': 'form-control'}),
            'valor_aplicable_aportacion': forms.NumberInput(attrs={'class': 'form-control'}),
        }
        help_texts = {
            ...
            'tipo_Aportacion': 'Seleccione el tipo de aportacion',
            'valor_aplicable_aportacion': 'Ingrese el valor aplicable a la aportación',
        }
