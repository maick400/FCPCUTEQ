...
urlpatterns = [
    ...
    # path('solicitudes_generales/listar', , name='listar_tipo_fondo'),
    # path('solicitudes_generales/editar/<pk>/', , name='editar_tipo_fondo'),
    # path('solicitudes_generales/buscar', , name='buscar_tipo_fondo'),
    # TODO----------------------RUTAS TIPO FONDO----------------------#

    path('modulos/registrar/', agregar_modulo, name='crear_tipo_fondo'),
    path('modulos/listar', listar_modulos, name='listar_tipo_fondo'),
    path('modulos/editar/<pk>/', editar_modulo, name='editar_tipo_fondo'),
    path('modulos/buscar', buscar_modulo, name='buscar_tipo_fondo'),
