...
class Model_FND_socio(models.Model):
    ...
    tipo_identificacion = models.TextField(max_length=5, choices=TIPO_IDENTIFICACION_CHOICES, null=False, blank=False, verbose_name='Tipo de Identificación')
    ...
    pais = models.TextField(max_length=5,choices=PAIS_CHOICES, null=False, blank=False, verbose_name='País')
    ...
    foto_ruta = models.ImageField(max_length=2000, null=False, blank=False, verbose_name='Ruta de Foto',upload_to='moduloFondo/socio/fotos/')
    ...
    tipo_sistema = models.TextField(max_length=5,choices=TIPO_SISTEMA_CHOICES, null=False, blank=False, verbose_name='Tipo de Sistema')
    base_calculo_aportacion = models.TextField(max_length=5,choices=BASE_CALCULO_APORTACION_CHOICES, null=False, blank=False, verbose_name='Base de Cálculo de Aportación')
    tipo_relacion = models.TextField(max_length=5,choices=TIPO_RELACION_CHOICES, null=False, blank=False, verbose_name='Tipo de Relación')
    estado_registro = models.TextField(max_length=5,choices=ESTADO_DE_REGISTRO_CHOICES, null=False, blank=False, verbose_name='Estado de Registro')
