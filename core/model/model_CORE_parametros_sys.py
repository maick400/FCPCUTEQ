...
class Model_FND_Parametros_sys(models.Model):
    ...
    pocentaje__seguro_prima  = models.DecimalField(max_digits=4, decimal_places=2, null= False , blank=False, verbose_name='Porcentaje PRIMA seguro')
    ...
    representante_legal_id = models.ForeignKey(Personal, on_delete=models.CASCADE, null=False, blank=False, verbose_name='Representante' ,related_name='reprensentante legal' , db_column='representante_legal_id')
    ...
    responsable_credito_id_personal = models.ForeignKey(Personal, on_delete= models.CASCADE, related_name='Representante de crédito', verbose_name='Responsable de cŕeditos', db_column='reprensentante_credito_id_personal')
